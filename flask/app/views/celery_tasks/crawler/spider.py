        ...
        for row in range(website_db.shape[0]):
            ...
            try:
                ...
                for i in range(2):
                    ...
                    self.dict_crawl["crawler_description"].append(css_description)
                ...
                df.to_sql(
                    name="statusLog", con=db.engine, if_exists="append", index=False
                )
                ...
                df_error.to_sql(
                    name="error", con=db.engine, if_exists="append", index=False
                )
