...
def get_rss_by_tid(get_tid):
    ...
    crawler_data = db.session.query(Website_crawler_structure)\
                        ...
                        .with_entities(Website_crawler_structure.website_name,Website_crawler_structure.tid,Crawler_clean_data)\
                        .all()
